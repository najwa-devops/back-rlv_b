...
public interface BankTransactionRepository extends JpaRepository<BankTransaction, Long> {
    ...
    @Query("""
            ...
            WHERE MONTH(t.dateOperation) = :nmois
              ...
              AND s.status IN (com.example.releve_bancaire.releve_bancaire.entity.BankStatus.VALIDATED, com.example.releve_bancaire.releve_bancaire.entity.BankStatus.COMPTABILISE)
